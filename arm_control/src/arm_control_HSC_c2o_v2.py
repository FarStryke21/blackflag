...
def HSC_c2o_v2(group,base):
  ...
  pos[:,5] = [base, -4.43, 1.25, 6.07, -0.9] #HSC-4
  pos[:,6] = [base, -4.43, 1.25, 6.07, -0.9] #HSC-4
  pos[:,7] = [base, -4.43, 1.25, 6.07, -0.9] #HSC-4
  pos[:,8] = [base, -4.47, 1.42, 6.07, -0.9] #HSC-5
  pos[:,9] = [base, -4.47, 1.42, 6.07, -2.3] #HSC-4
  pos[:,10] = [base, -4.47, 1.25, 6.07, -2.3] #HSC-4
  pos[:,11] = [base, -4.23, 1.25, 4.86, -2.3] #HSC-2
  pos[:,12] = [base, -3.8, 2.23, 4.54, 0.0] #HSC-1
  pos[:,13] = [base, -3.29, 2.83, 4.09, 0.0] #Home2


  # The times to reach each waypoint (in seconds)
  time = np.linspace(0, 30, 14)
